...
export const FRAMEWORKS: Framework[] = [
  {
    ...
    keyPoints: [
      ...
      { h: "AI literacy (Article 4)", p: "Providers and deployers must ensure staff who use AI on their behalf have a sufficient level of AI literacy. A documented internal policy and training is the simplest way to evidence it." },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      { h: "Map", p: "Understand the context and catalogue where AI is used and what could go wrong. In practice, keep an AI tool register." },
  ...
  },
  {
    ...
    keyPoints: [
      { h: "Certifiable", p: "You can be audited and certified against it by an accredited body, which is useful proof for customers and regulators." },
  ...
  },
  {
    ...
    keyPoints: [
      { h: "Type I vs Type II", p: "Type I tests control design at a point in time; Type II tests operating effectiveness over a period (usually 3 to 12 months) and is what enterprise buyers want." },
