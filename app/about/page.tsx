...
export const metadata: Metadata = pageMeta({
  title: "About ModelCharter",
  description: "Why ModelCharter exists: AI governance built for the millions of teams that use AI every day but do not have a compliance department.",
  path: "/about",
});
    ...
    <>
      ...
      <Section className="max-w-2xl py-12 sm:py-16">
        <div className="space-y-5 text-lg leading-relaxed text-ink-soft">
          ...
          <p className="text-sm text-ink-faint">ModelCharter provides guidance, not legal advice. Always confirm vendor facts against their official policies, and have a qualified advisor review any policy before you adopt it.</p>
        </div>
