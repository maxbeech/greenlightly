...
const FAQS = [
  { q: "What should an AI usage policy include?", a: "At minimum: who it applies to, which AI tools are approved, what data may and may not be entered into AI tools, transparency and disclosure rules, any regulatory obligations (EU AI Act, GDPR, HIPAA, SOC 2), and who owns the policy and handles breaches. Greenlightly's generator produces all of these, tailored to your answers." },
